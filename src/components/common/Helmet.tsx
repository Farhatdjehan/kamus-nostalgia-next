  ...
  return (
    <>
      <Head>
        ...
        <meta name="image" content="https://ibb.co/zZfXsbp" />
        ...
        <meta property="og:image" content="https://ibb.co/zZfXsbp" />
        ...
        <meta name="twitter:image" content="https://ibb.co/zZfXsbp"></meta>
